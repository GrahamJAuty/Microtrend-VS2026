...
CSmartPaySemaphoreTidyUpThreadInfo::CSmartPaySemaphoreTidyUpThreadInfo()
{
	m_bForceQuit = FALSE;
...
void CSmartPaySemaphoreTidyUpThreadInfo::ResetState(int nState)
{
...
UINT CSmartPaySemaphoreTidyUpThread::DoWork( LPVOID pParam )
{
	CSmartPaySemaphoreTidyUpThreadInfo* pInfo = (CSmartPaySemaphoreTidyUpThreadInfo*) pParam;
...
void CSmartPaySemaphoreTidyUpThread::DoWorkInternal( CSmartPaySemaphoreTidyUpThreadInfo* pInfo )
{
	do
	{
		CString strFolder = "";
