...
#ifndef BGNDICON
	SetWindowText("SmartPay Server Module");
#else
	SetWindowText("SmartPay Background Processor Module");
#endif
...
#ifndef BGNDICON
	CommandLineBuilder.AddToken(".\\SPosSmartPay4Server.EXE");
#else
	CommandLineBuilder.AddToken(".\\SPosSmartPay4Bgnd.EXE");
#endif
