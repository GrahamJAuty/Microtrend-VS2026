...
void CLaunchWaitDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_STATIC_REQUEST, m_staticRequest);
...
#ifndef BGNDICON
	SetWindowText("Launch Server as Desktop App");
	m_staticRequest.SetWindowText("Requesting other server instances to stop.");
#else
	SetWindowText("Launch Background Processor as Desktop App");
	m_staticRequest.SetWindowText("Requesting other background processor instances to stop.");
#endif
