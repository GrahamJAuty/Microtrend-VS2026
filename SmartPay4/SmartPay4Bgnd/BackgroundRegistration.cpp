...
CBackgroundRegistration::CBackgroundRegistration()
{
...
void CBackgroundRegistration::CheckRegistration()
{
...
bool CBackgroundRegistration::CheckDbAccess(bool bLogErrors)
{
	SQLConnectionOptions.Read();
	g_GlobalState.DetermineODBCDriverVersion(2, bLogErrors);
...
bool CBackgroundRegistration::CanGiveUp()
{
	ULONGLONG timeNow = GetTickCount64();
