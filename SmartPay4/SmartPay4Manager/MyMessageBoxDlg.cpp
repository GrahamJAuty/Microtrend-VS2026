...
CMyMessageBoxDlg::CMyMessageBoxDlg( CMyMessageBoxInfo& MessageBoxInfo, CWnd* pParent)
	: CSSAutoShutdownDialog(AutoShutdownHelper,CMyMessageBoxDlg::IDD, pParent), m_MessageBoxInfo( MessageBoxInfo ), m_staticMessage( MessageBoxInfo )
{
}
...
BEGIN_MESSAGE_MAP(CMyMessageBoxDlg, CSSAutoShutdownDialog)
...
BOOL CMyMessageBoxDlg::CSSAutoShutdownPostInitDialog() 
{	
	{
...
void CMyMessageBoxDlg::CSSAutoShutdownLogOff()
{
	switch (m_MessageBoxInfo.GetButtonMode())
	{
	case MB_OK:
