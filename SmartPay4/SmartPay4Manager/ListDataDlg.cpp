...
CListDataDlg::CListDataDlg(CWnd* pParent)
	: CSSAutoShutdownDialog(AutoShutdownHelper, CListDataDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CListDataDlg, CSSAutoShutdownDialog)
...
BOOL CListDataDlg::CSSAutoShutdownPostInitDialog()
{
	SetTitle();
	SetButtonTexts();
	SetColumns();
...
void CListDataDlg::CSSAutoShutdownLogOff()
{
	OnCancel();
}
