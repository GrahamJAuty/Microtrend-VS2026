...
/**********************************************************************/
IMPLEMENT_DYNCREATE(CSystemPropertyPage9, CPropertyPage)
/**********************************************************************/

CSystemPropertyPage9::CSystemPropertyPage9() : CSSAutoShutdownPropertyPage(AutoShutdownHelper, CSystemPropertyPage9::IDD)
{
	//{{AFX_DATA_INIT(CSystemPropertyPage9)
	//}}AFX_DATA_INIT
	m_nEditingColour = 0;
}
...
CSystemPropertyPage9::~CSystemPropertyPage9()
{
}

/**********************************************************************/

void CSystemPropertyPage9::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSystemPropertyPage9)
...
BEGIN_MESSAGE_MAP(CSystemPropertyPage9, CSSAutoShutdownPropertyPage)
	//{{AFX_MSG_MAP(CSystemPropertyPage9)
...
BOOL CSystemPropertyPage9::OnInitDialog() 
{
	GetRecordData();
...
void CSystemPropertyPage9::ToggleEnables()
{
...
BOOL CSystemPropertyPage9::OnKillActive() 
{
...
BOOL CSystemPropertyPage9::OnSetActive() 
{
	GetRecordData();
...
void CSystemPropertyPage9::GetRecordData()
{
}

/**********************************************************************/

void CSystemPropertyPage9::SaveRecord()
{
	//CUSTOM MESSAGE BOX
...
void CSystemPropertyPage9::SetRecordControls()
{
}

/**********************************************************************/

void CSystemPropertyPage9::OnButtonMessageBack()
{
...
void CSystemPropertyPage9::OnButtonMessageText()
{
...
long CSystemPropertyPage9::OnColourButtonMessage( WPARAM w, LPARAM l )
{
...
void CSystemPropertyPage9::OnButtonMessagePreview()
{
	int nFontSize = 8;
	switch( m_comboMessageFont.GetCurSel() )
	{
