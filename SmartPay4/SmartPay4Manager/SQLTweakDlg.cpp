...
CSQLTweakDlg::CSQLTweakDlg( CWnd* pParent /*=NULL*/)
	: CSSAutoShutdownDialog( AutoShutdownHelper, CSQLTweakDlg::IDD, pParent)
{
}
...
BEGIN_MESSAGE_MAP(CSQLTweakDlg, CSSAutoShutdownDialog)
...
BOOL CSQLTweakDlg::CSSAutoShutdownPostInitDialog()
{
...
void CSQLTweakDlg::CSSAutoShutdownLogOff()
{
	OnCancel();
}
