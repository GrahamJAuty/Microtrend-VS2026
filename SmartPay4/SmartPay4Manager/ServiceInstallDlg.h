...
public:
	void UpdateDisplay( CSSAutoShutdownDialog* pParent );
...
class CServiceInstallDlg : public CSSAutoShutdownDialog
{
public:
	CServiceInstallDlg( bool bBackground, CWnd* pParent = NULL); 
