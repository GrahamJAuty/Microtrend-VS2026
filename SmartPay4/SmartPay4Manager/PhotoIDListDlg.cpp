...
CPhotoIDListDlg::CPhotoIDListDlg(CWnd* pParent /*=NULL*/)
	: CSSAutoShutdownDialog(AutoShutdownHelper, CPhotoIDListDlg::IDD, pParent)
	, m_bSkipNoPhoto(TRUE)
	, m_strLabelName(_T(""))
{
	m_bPrintReqd = FALSE;
...
BEGIN_MESSAGE_MAP(CPhotoIDListDlg, CSSAutoShutdownDialog)
...
BOOL CPhotoIDListDlg::CSSAutoShutdownPostInitDialog()
{
