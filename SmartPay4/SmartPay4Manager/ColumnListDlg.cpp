...
: CSSAutoShutdownDialog(AutoShutdownHelper, CColumnListDlg::IDD, pParent), m_arrayPos( arrayPos )
{
...
BEGIN_MESSAGE_MAP(CColumnListDlg, CSSAutoShutdownDialog)
...
BOOL CColumnListDlg::CSSAutoShutdownPostInitDialog()
{
	CString strTitle;
