...
CColourEditDlg::CColourEditDlg( int nColourRef, const char* szTitle, CWnd* pMainWnd, CWnd* pParent)
	: CSSAutoShutdownDialog(AutoShutdownHelper, CColourEditDlg::IDD, pParent)
{
	m_pMainWnd = pMainWnd;
...
BEGIN_MESSAGE_MAP(CColourEditDlg, CSSAutoShutdownDialog)
...
BOOL CColourEditDlg::CSSAutoShutdownPostInitDialog() 
{
...
void CColourEditDlg::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
	...
	CSSAutoShutdownDialog::OnHScroll(nSBCode, nPos, pScrollBar);
}
