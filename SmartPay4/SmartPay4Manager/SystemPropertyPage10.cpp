...
CSystemPropertyPage10::CSystemPropertyPage10() : CSSAutoShutdownPropertyPage(AutoShutdownHelper,CSystemPropertyPage10::IDD)
{
	//{{AFX_DATA_INIT(CSystemPropertyPage10)
	//}}AFX_DATA_INIT
	m_nType = 0;
	m_nActiveTab = 0;
}
...
CSystemPropertyPage10::~CSystemPropertyPage10()
{
}

/**********************************************************************/

void CSystemPropertyPage10::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSystemPropertyPage10)
...
BEGIN_MESSAGE_MAP(CSystemPropertyPage10, CSSAutoShutdownPropertyPage)
	//{{AFX_MSG_MAP(CSystemPropertyPage10)
...
BOOL CSystemPropertyPage10::OnInitDialog()
{
	...
	/*****/
	MoveControl(&m_checkExcludeZero, 16, 38);
	MoveControl(&m_staticAccessType, 16, 58);
	MoveControl(&m_comboAccessType, 150, 56);
	MoveControl(&m_staticCompression, 16, 78);
	MoveControl(&m_comboCompression, 150, 76);
...
void CSystemPropertyPage10::OnTcnSelchangeTabs(NMHDR *pNMHDR, LRESULT *pResult)
{
	*pResult = 0;
...
void CSystemPropertyPage10::SetActiveTabControls()
{
	SetTabControls( TRUE );
};
...
void CSystemPropertyPage10::SetTabControls(bool bActiveTabOnly)
{
...
BOOL CSystemPropertyPage10::OnKillActive() 
{
...
BOOL CSystemPropertyPage10::OnSetActive() 
{
	SetRecordControls();
...
void CSystemPropertyPage10::SetRecordControls()
{
	...
	//FOLDER
	m_strFolder = AutoBackupOptions.GetPath();
...
void CSystemPropertyPage10::SaveRecord()
{
	...
	AutoBackupOptions.SetPath( m_strFolder );
...
/**********************************************************************/
void CSystemPropertyPage10::OnRadioNone(){ SetType(0); }
void CSystemPropertyPage10::OnRadioHourly(){ SetType(1); }
void CSystemPropertyPage10::OnRadioDaily(){ SetType(2); }
void CSystemPropertyPage10::OnRadioWeekly(){ SetType(3); }
void CSystemPropertyPage10::OnRadioCustom(){ SetType(4); }
/**********************************************************************/

void CSystemPropertyPage10::SetType( int n )
{
	m_nType = n;
...
void CSystemPropertyPage10::OnTogglePrompt()
{
...
void CSystemPropertyPage10::OnButtonEdit()
{
	CAutoShutdownPropSheetStacker Stacker((CSystemPropertySheet*)GetParent());
...
void CSystemPropertyPage10::OnButtonCheck()
{
...
void CSystemPropertyPage10::CheckBackupPath( bool bMessageIfOK )
{
	CAutoShutdownPropSheetStacker Stacker((CSystemPropertySheet*)GetParent());
...
bool CSystemPropertyPage10::ValidateFolderAccess(const char* szPath)
{
	bool bReply = FALSE;
...
void CSystemPropertyPage10::OnButtonSchedule()
{
	CAutoShutdownPropSheetStacker Stacker((CSystemPropertySheet*)GetParent());
...
void CSystemPropertyPage10::OnButtonInfo()
{
	CAutoShutdownPropSheetStacker Stacker((CSystemPropertySheet*)GetParent());
