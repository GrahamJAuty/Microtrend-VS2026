...
void CPasswordLogger::LogEvent(int nPasswordNo, int nEventType)
{
	...
	case PASSWORD_EVENT_LOGON_MENU:
		...
		m_bLogEnabledAtLogon = (System.GetUsePasswordsFlag()) && Passwords.InUse();
		break;
	}
	...
	case PASSWORD_EVENT_LOGOFF_MENU:
		if (m_strLogonDate != "")
		{
			bool bLogEnabledNow = (System.GetUsePasswordsFlag()) && Passwords.InUse();
