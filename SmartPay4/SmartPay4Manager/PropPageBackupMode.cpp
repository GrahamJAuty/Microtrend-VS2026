...
CPropPageBackupMode::CPropPageBackupMode() : CSSAutoShutdownPropertyPage(AutoShutdownHelper,CPropPageBackupMode::IDD)
{
...
BEGIN_MESSAGE_MAP(CPropPageBackupMode, CPropertyPage)
	//{{AFX_MSG_MAP(CPropPageBackupMode,CSSAutoShutdownPropertyPage)
