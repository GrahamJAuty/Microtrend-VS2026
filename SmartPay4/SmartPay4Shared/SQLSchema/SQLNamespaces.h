...
namespace SQLTableNames
{
	...
	const char* const PINNumber = "PINNumber";
	const char* const PebbleConfig = "PebbleConfig";
	const char* const PebbleExportTransactions = "PebbleExportTrans";
	const char* const PebbleExportTransactionsSent = "PebbleExportTransSent";
	...
	const char* const PebbleLinkTimes = "PebbleLinkTimes";
	...
	const char* const WebPaymentOptions = "WebPaymentOptions";
	const char* const PurchaseHistoryHeader = "PurchaseHistoryHeader";
};
...
namespace Account
{
	...
	/*****/
	const recDouble	MaxSpendPurse1Period1 = { "MaxSpendPurse1Period1", 0.00, 999999.99 };
	const recDouble	MaxSpendPurse1Period2 = { "MaxSpendPurse1Period2", 0.00, 999999.99 };
	const recDouble	MaxSpendPurse1Period3 = { "MaxSpendPurse1Period3", 0.00, 999999.99 };
	const recDouble	MaxSpendPurse1Period4 = { "MaxSpendPurse1Period4", 0.00, 999999.99 };
	const recDouble	MaxSpendPurse1Period5 = { "MaxSpendPurse1Period5", 0.00, 999999.99 };
	const recDouble	MaxSpendPurse1Period6 = { "MaxSpendPurse1Period6", 0.00, 999999.99 };
	/*****/
	const recDouble	MaxSpendPurse3Period1 = { "MaxSpendPurse3Period1", 0.00, 999999.99 };
	const recDouble	MaxSpendPurse3Period2 = { "MaxSpendPurse3Period2", 0.00, 999999.99 };
	const recDouble	MaxSpendPurse3Period3 = { "MaxSpendPurse3Period3", 0.00, 999999.99 };
	const recDouble	MaxSpendPurse3Period4 = { "MaxSpendPurse3Period4", 0.00, 999999.99 };
	const recDouble	MaxSpendPurse3Period5 = { "MaxSpendPurse3Period5", 0.00, 999999.99 };
	const recDouble	MaxSpendPurse3Period6 = { "MaxSpendPurse3Period6", 0.00, 999999.99 };
	/*****/
	const recDouble	MaxOverdraftPurse1Period1 = { "MaxOverdraftPurse1Period1", 0.00, 999999.99 };
	const recDouble	MaxOverdraftPurse1Period2 = { "MaxOverdraftPurse1Period2", 0.00, 999999.99 };
	const recDouble	MaxOverdraftPurse1Period3 = { "MaxOverdraftPurse1Period3", 0.00, 999999.99 };
	const recDouble	MaxOverdraftPurse1Period4 = { "MaxOverdraftPurse1Period4", 0.00, 999999.99 };
	const recDouble	MaxOverdraftPurse1Period5 = { "MaxOverdraftPurse1Period5", 0.00, 999999.99 };
	const recDouble	MaxOverdraftPurse1Period6 = { "MaxOverdraftPurse1Period6", 0.00, 999999.99 };
	/*****/
	const recDouble	MaxOverdraftPurse3Period1 = { "MaxOverdraftPurse3Period1", 0.00, 999999.99 };
	const recDouble	MaxOverdraftPurse3Period2 = { "MaxOverdraftPurse3Period2", 0.00, 999999.99 };
	const recDouble	MaxOverdraftPurse3Period3 = { "MaxOverdraftPurse3Period3", 0.00, 999999.99 };
	const recDouble	MaxOverdraftPurse3Period4 = { "MaxOverdraftPurse3Period4", 0.00, 999999.99 };
	const recDouble	MaxOverdraftPurse3Period5 = { "MaxOverdraftPurse3Period5", 0.00, 999999.99 };
	const recDouble	MaxOverdraftPurse3Period6 = { "MaxOverdraftPurse3Period6", 0.00, 999999.99 };
	/*****/
...
namespace Group
{
	...
	const recInt	 VATShift = { "VatShift", 0, 1 };						// 0-no shift, 1=yes ( AtoD / BtoE / CtoF )
	const recBool PurchaseControlFlag = { "PurchaseControlFlag" };
	const recBool AllowRevalKioskFlag = { "AllowRevalKioskFlag" };
	/****/
	...
	const recDouble RefreshValue = { "RefreshValue", 0, 999999.99 };
	...
	const recDouble RefreshValuePeriod1 = { "RefreshValuePeriod1", 0, 999999.99 };
	const recDouble RefreshValuePeriod2 = { "RefreshValuePeriod2", 0, 999999.99 };
	const recDouble RefreshValuePeriod3 = { "RefreshValuePeriod3", 0, 999999.99 };
	const recDouble RefreshValuePeriod4 = { "RefreshValuePeriod4", 0, 999999.99 };
	const recDouble RefreshValuePeriod5 = { "RefreshValuePeriod5", 0, 999999.99 };
	const recDouble RefreshValuePeriod6 = { "RefreshValuePeriod6", 0, 999999.99 };
	/****/
	...
	/*****/
	const recDouble	LowBalancePurse1 = { "LowBalancePurse1", 0, 999999.99 };		// Low Balance Purse1 warning level
	const recDouble	LowBalancePurse2 = { "LowBalancePurse2", 0, 999999.99 };		// Low Balance Purse2 warning level
	const recDouble	LowBalancePurse3 = { "LowBalancePurse3", 0, 999999.99 };		// Low Balance Purse3 warning level
	/*****/
...
namespace BioRegister
{
	const recInt64	UserID = { "UserID", 1, 9999999999 };
	const recString	Username = { "Username", 0, 40 };
	const recInt	Counter = { "Counter", 1, 0x7FFFFFFF };
...
namespace PebbleConfig
{
	...
	const recInt VATCODE_A = { "VATCODE_A", 0, 5 };
	const recInt VATCODE_B = { "VATCODE_B", 0, 5 };
	const recInt VATCODE_C = { "VATCODE_C", 0, 5 };
	const recInt VATCODE_D = { "VATCODE_D", 0, 5 };
	const recInt VATCODE_E = { "VATCODE_E", 0, 5 };
	const recInt VATCODE_F = { "VATCODE_F", 0, 5 };
	const recInt VATCODE_G = { "VATCODE_G", 0, 5 };
	const recInt VATCODE_H = { "VATCODE_H", 0, 5 };
	const recInt VATCODE_I = { "VATCODE_I", 0, 5 };
	const recInt VATCODE_J = { "VATCODE_J", 0, 5 };
	const recInt VATCODE_K = { "VATCODE_K", 0, 5 };
	const recInt VATCODE_L = { "VATCODE_L", 0, 5 };
...
namespace PebbleExportTransaction
{
	const recInt64 LineID = { "LineID", 1, 0x7FFFFFFFFFFFFFFF };
	const recInt64 UserID = { "UserID", 0, 9999999999 }; 
	const recInt64 XFerUserID = { "XFerUserID", 0, 9999999999 };
	const recString MemberID = { "MemberID", 0, 26 };
...
namespace PebbleExportTransactionSent
{
	const recInt64 LineID = { "LineID", 1, 0x7FFFFFFFFFFFFFFF };
	const recInt64 TranLineID = { "TranLineID", 1, 0x7FFFFFFFFFFFFFFF };
};
...
namespace PebbleLinkTime
{
	const recInt64 LineID = { "LineID", 1, 0x7FFFFFFFFFFFFFFF };
	const recString Date = { "Date", 0, 8 };  
	const recString Time = { "Time", 0, 6 };  
	const recInt64	UserID = { "UserID", 0, 9999999999 }; 
	const recInt GroupNo = { "GroupNo", 1 , 99 };
	const recString	Username = { "Username", 0, 40 };
	const recString	Forename = { "Forename", 0, 40 };
	const recString	Surname = { "Surname", 0, 40 };
	const recString	PebbleFirstName = { "PebbleFirstName", 0, 40 };
	const recString	PebbleLastName = { "PebbleLastName", 0, 40 };
	const recInt ProcessType = { "ProcessType", 0, 1 };
	const recInt MatchType = { "MatchType", 0, 1 };
	const recString	MIS = { "MIS", 0, 80 };
	const recString	UPN = { "UPN", 0, 80 };
};
...
namespace AuditPendingExport
{
	...
	const recString XFerUserID = { "XFerUserID", 0, 30 };
...
namespace WebPaymentOption
{
	const recInt LineID = { "LineID", 1, 1 };
	const recInt AccountLinkDays = { "AccountLinkDays", 0, 0x3F };
	const recString AccountLinkStart = { "AccountLinkStart", 0, 5 };
	const recString AccountLinkEnd = { "AccountLinkEnd", 0, 5 };
	const recString AccountLinkLastDate = { "AccountLinkLastDate", 0, 10 };
	const recString AccountLinkLastTime = { "AccountLinkLastTime", 0, 5 };
	const recInt PaymentDays = { "PaymentDays", 0, 0x3F };
	const recString PaymentStart = { "PaymentStart", 0, 5 };
	const recString PaymentEnd = { "PaymentEnd", 0, 5 };
	const recString PaymentLastDate = { "PaymentLastDate", 0, 10 };
	const recString PaymentLastTime = { "PaymentLastTime", 0, 5 };
	const recString BalanceLastDate = { "BalanceLastDate", 0, 10 };
	const recString BalanceLastTime = { "BalanceLastTime", 0, 5 };
	const recString TransactionLastDate = { "TransactionLastDate", 0, 10 };
	const recString TransactionLastTime = { "TransactionLastTime", 0, 5 };
	const recBool Exclude1Flag = { "Exclude1Flag" };
	const recString Exclude1Start = { "Exclude1Start", 0, 5 };
	const recString Exclude1End = { "Exclude1End", 0, 5 };
	const recBool Exclude2Flag = { "Exclude2Flag" };
	const recString Exclude2Start = { "Exclude2Start", 0, 5 };
	const recString Exclude2End = { "Exclude2End", 0, 5 };
	const recBool Exclude3Flag = { "Exclude3Flag" };
	const recString Exclude3Start = { "Exclude3Start", 0, 5 };
	const recString Exclude3End = { "Exclude3End", 0, 5 };
	const recBool Exclude4Flag = { "Exclude4Flag" };
	const recString Exclude4Start = { "Exclude4Start", 0, 5 };
	const recString Exclude4End = { "Exclude4End", 0, 5 };
	const recString ExcludeUploadStart = { "ExcludeUploadStart", 0, 5 };
	const recString ExcludeUploadEnd = { "ExcludeUploadEnd", 0, 5 };
	const recBool EODAfterPaymentFlag = { "EODAfterPaymentFlag" };	
	const recString EODAfterTime = { "EODAfterTime", 0, 5 };
	const recBool PromptBeforeAccessFlag = { "PromptBeforeAccessFlag" };
	const recBool ImportAccountsFlag = { "ImportAccountsFlag" };
	const recInt64 RowVersion = { "RowVersion", 0, 0x7FFFFFFFFFFFFFFF };
}

//**********************************************************************

namespace PurchaseHistoryHeader
{
	const recInt64 LineID = { "LineID", 1, 0x7FFFFFFFFFFFFFFF };
	const recString Date = { "Date", 0, 8 };
	const recString Time = { "Time", 0, 6 };
...
namespace PINNumber
{
	const recString	PINNumber = { "PINNumber", 4, 4 };
	const recString	UserID = { "UserID", 0, 10 };
	const recString	Username = { "Username", 0, 40 };
	const recString	FirstDate = { "FirstDate", 0, 8 };
	const recString	FirstTime = { "FirstTime", 0, 8 };
	const recString	LastDate = { "LastDate", 0, 8 };
	const recString	LastTime = { "LastTime", 0, 8 };
	const recInt	UseCounter = { "UseCounter", 1, 0x7FFFFFFF };
};
...
namespace CCNo
{
	...
	const recInt TypeInt = { "TypeInt", 0, 7 };
	const recInt Number = { "Number", 0, 99999999 };
};
