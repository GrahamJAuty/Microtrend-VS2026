...
/**********************************************************************/
#include "..\SmartPay4Manager\SMTPEmailHelpers.h"
/**********************************************************************/
#endif
/**********************************************************************/
...
CEmailOptions::CEmailOptions()
{
	...
	m_EmailSmartPayDirect.Create("EmailSMTPSmartPayDirect", FALSE);
...
void CEmailOptions::ReloadFromIniFile(CEnhancedIniFile& iniFile)
{
	...
	iniFile.ReadBool(m_EmailSmartPayDirect);
}
...
void CEmailOptions::PrepareIniFile(CEnhancedIniFile& iniFile)
{
	...
	iniFile.WriteBool(m_EmailSmartPayDirect);
}
...
bool CEmailOptions::GetEmailSMTPSmartPayDirectFlagToUse()
{
	return GetEmailSMTPSmartPayDirectFlagInternal();
}

/**********************************************************************/

bool CEmailOptions::UseSMTPForDirectEmail()
{
	bool bResult = FALSE; 

	switch (m_EmailMethod.GetValue())
	{
	case 1:
	case 2:
		bResult = m_EmailSmartPayDirect.GetValue();
		break;
	}
