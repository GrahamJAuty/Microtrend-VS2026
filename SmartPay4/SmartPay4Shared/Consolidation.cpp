...
CSortedStringAndIntByInt64::CSortedStringAndIntByInt64()
{
	Reset();
}
...
void CSortedStringAndIntByInt64::Reset()
{
	m_nKey = 0;
	m_strVal = "";
	m_nVal = 0;
...
void CSortedStringAndIntByInt64::Add(CSortedStringAndIntByInt64& source)
{
}

/**********************************************************************/

int CSortedStringAndIntByInt64::Compare(CSortedStringAndIntByInt64& source, int nHint)
{
	if (m_nKey != source.m_nKey)
		return (m_nKey > source.m_nKey ? 1 : -1);
	else
...
{
	CString strThisKey = m_strKey;
	CString strSourceKey = source.m_strKey;

	if (1 == nHint)
	{
		strThisKey.MakeUpper();
		strSourceKey.MakeUpper();
	}

	if (strThisKey != strSourceKey)
	{
		return (strThisKey > strSourceKey ? 1 : -1);
	}
	else
	{
		return 0;
...
CConsolidatedDoubleAndStringByInt::CConsolidatedDoubleAndStringByInt()
{
	Reset();
}
...
void CConsolidatedDoubleAndStringByInt::Reset()
{
	m_nKey = 0;
	m_dVal = 0.0;
	m_strVal = "";
...
void CConsolidatedDoubleAndStringByInt::Add(CConsolidatedDoubleAndStringByInt& source)
{
	m_dVal += source.m_dVal;
...
int CConsolidatedDoubleAndStringByInt::Compare(CConsolidatedDoubleAndStringByInt& source, int nHint)
{
	if (m_nKey != source.m_nKey)
		return (m_nKey > source.m_nKey ? 1 : -1);
	else
...
CReportStatementAccountInfo::CReportStatementAccountInfo()
{
	Reset();
}
...
void CReportStatementAccountInfo::Reset()
{
	m_nUserID = 0;
	m_nFilePos = 0;
}
...
void CReportStatementAccountInfo::Add(CReportStatementAccountInfo& source)
{
}

/**********************************************************************/

int CReportStatementAccountInfo::Compare(CReportStatementAccountInfo& source, int nHint)
{
	if (m_nUserID != source.m_nUserID)
		return (m_nUserID > source.m_nUserID ? 1 : -1);
	
	if (m_nFilePos != source.m_nFilePos)
		return (m_nFilePos > source.m_nFilePos ? 1 : -1);
	else
		return 0;
}
...
CEPosPaymentGroupSale::CEPosPaymentGroupSale()
{
	Reset();
}
...
void CEPosPaymentGroupSale::Reset()
{
	m_nGroupNo = 0;
	m_strGroupText = "";
	m_dPurse1 = 0.0;
...
void CEPosPaymentGroupSale::Add(CEPosPaymentGroupSale& source)
{
	m_dPurse1 += source.m_dPurse1;
	m_dPurse2 += source.m_dPurse2;
	m_dPurse3 += source.m_dPurse3;
	m_dOther += source.m_dOther;
}

/**********************************************************************/

int CEPosPaymentGroupSale::Compare(CEPosPaymentGroupSale& source, int nHint)
{
	if (m_nGroupNo != source.m_nGroupNo)
		return (m_nGroupNo > source.m_nGroupNo ? 1 : -1);
	else
...
CPurchaseControlRSPBuffer::CPurchaseControlRSPBuffer()
{
	Reset();
}
...
void CPurchaseControlRSPBuffer::Reset()
{
	m_nRuleID = 0;
	m_strRuleName = "";
	m_nStampCount = 0;
...
void CPurchaseControlRSPBuffer::Add(CPurchaseControlRSPBuffer& source)
{
...
int CPurchaseControlRSPBuffer::Compare(CPurchaseControlRSPBuffer& source, int nHint)
{
	if (m_nRuleID != source.m_nRuleID)
		return (m_nRuleID > source.m_nRuleID ? 1 : -1);
	else
		return 0;
}
...
CStartingBalanceSortItem::CStartingBalanceSortItem()
{
	Reset();
}
...
void CStartingBalanceSortItem::Reset()
{
	m_nUserID = 0;
	m_nGroupNo = 0;
	m_nFilePos = 0;
...
void CStartingBalanceSortItem::Add(CStartingBalanceSortItem& source)
{
	m_nGroupNo = source.m_nGroupNo;
	m_nFilePos = source.m_nFilePos;
}

/**********************************************************************/

int CStartingBalanceSortItem::Compare(CStartingBalanceSortItem& source, int nHint)
{
	if (1 == nHint)
	{
		if (m_nGroupNo != source.m_nGroupNo)
