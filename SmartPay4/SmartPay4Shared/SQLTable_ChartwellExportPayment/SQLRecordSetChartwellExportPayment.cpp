...
CSQLRecordSetMetadataChartwellExportPayment::CSQLRecordSetMetadataChartwellExportPayment(bool bForExistenceCheck) : CSQLRecordSetMetadata()
{
...
CSQLRecordSetChartwellExportPayment::CSQLRecordSetChartwellExportPayment(CDatabase* pDatabase, RSParams_ChartwellExportPayment_NormalNoParams params) :
...
CSQLRecordSetChartwellExportPayment::CSQLRecordSetChartwellExportPayment(CDatabase* pDatabase, RSParams_ChartwellExportPayment_NormalByTranDetail params, bool bForExistenceCheck) :
	CSQLRecordSetConnectionPool(pDatabase),
