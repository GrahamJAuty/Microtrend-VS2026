...
CSmartPaySemaphoreThreadInfo::CSmartPaySemaphoreThreadInfo()
{
	m_bForceQuit = FALSE;
...
UINT CSmartPaySemaphoreThread::DoWork( LPVOID pParam )
{
	CSmartPaySemaphoreThreadInfo* pInfo = (CSmartPaySemaphoreThreadInfo*) pParam;
...
void CSmartPaySemaphoreThread::DoWorkInternal( CSmartPaySemaphoreThreadInfo* pInfo )
{
	do
	{
...
void CSmartPaySemaphoreThread::CreateLockFile( CString strFolder )
{
