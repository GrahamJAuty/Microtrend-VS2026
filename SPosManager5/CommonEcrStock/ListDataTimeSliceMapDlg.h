...
class CSingleListContentHelpersTimeSliceMap : public CSingleListContentHelpers
{
public:
	CSingleListContentHelpersTimeSliceMap( int& nChangedMaps );
...
class CListDataTimeSliceMapDlg : public CListDataDlg
{
public:
	CListDataTimeSliceMapDlg( int nInitialSel, int& nChangedMaps, CWnd* pParent = NULL); 
	~CListDataTimeSliceMapDlg();
