...
class CSPOSKeyboardPropPageEditScreenLoggedOff : public CSSPropertyPage
{
public:
	CSPOSKeyboardPropPageEditScreenLoggedOff();
	~CSPOSKeyboardPropPageEditScreenLoggedOff();

	//{{AFX_DATA(CSPOSKeyboardPropPageEditScreenLoggedOff)
	enum { IDD = IDD_PROPPAGE_EDITSCREEN_LOGGEDOFF };
	CSSComboBox m_comboFunction;
	CString m_strName;
	int m_nScreenStyle;
	//}}AFX_DATA

	//{{AFX_VIRTUAL(CSPOSKeyboardPropPageEditScreenLoggedOff)
	public:
...
protected:
	//{{AFX_MSG(CSPOSKeyboardPropPageEditScreenLoggedOff)
