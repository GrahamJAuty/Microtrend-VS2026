...
BOOL CBackupPromptDlg::OnInitDialog()
{
	...
	m_staticSystem.SetWindowText( "The Stock Manager system data has not been backed up since" );
#else
	m_staticSystem.SetWindowText( "The Ecr Manager system data has not been backed up since" );
#endif
