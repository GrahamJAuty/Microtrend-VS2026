...
CReportEposPMSDlg::CReportEposPMSDlg( int nPresetNo, bool bPresetPrint, bool bAutoRunPreset, CWnd* pParent)
	: CSSDialog(CReportEposPMSDlg::IDD, pParent), 
	m_DepartmentSelector ( m_editDeptNo, m_comboDeptName ),
	m_DateSelectorRange( m_comboDates, m_DatePickerFrom, m_DatePickerTo )
{
	//{{AFX_DATA_INIT(CReportEposPMSDlg)
	//}}AFX_DATA_INIT
...
CReportEposPMSDlg::~CReportEposPMSDlg()
{
...
void CReportEposPMSDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CReportEposPMSDlg)
...
BEGIN_MESSAGE_MAP(CReportEposPMSDlg, CDialog)
	//{{AFX_MSG_MAP(CReportEposPMSDlg)
...
int CReportEposPMSDlg::GetSelectedReportType()
{
...
BOOL CReportEposPMSDlg::OnInitDialog() 
{
...
void CReportEposPMSDlg::OnMeasureItem(int nIDCtl, LPMEASUREITEMSTRUCT lpMeasureItemStruct)
{
	if ( nIDCtl == IDC_LIST )	
	{
...
void CReportEposPMSDlg::OnSelectBatch() 
{
...
void CReportEposPMSDlg::OnSelectReport(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CReportEposPMSDlg::OnDoubleClickList(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CReportEposPMSDlg::OnRadioPMSConsolidate1()
{
	m_dlgHelpers.HandlePMSRadioConsolidate(0);
}

/**********************************************************************/

void CReportEposPMSDlg::OnRadioPMSConsolidate2()
{
	m_dlgHelpers.HandlePMSRadioConsolidate(1);
}

/**********************************************************************/

void CReportEposPMSDlg::OnRadioPMSConsolidate3()
{
	m_dlgHelpers.HandlePMSRadioConsolidate(2);
}

/**********************************************************************/

void CReportEposPMSDlg::OnSelectDates() 
{
...
void CReportEposPMSDlg::OnChangeDateFrom(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CReportEposPMSDlg::OnChangeDateTo(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CReportEposPMSDlg::OnCheckQuickPrint() 
{
...
void CReportEposPMSDlg::OnSelectLocation() 
{
...
void CReportEposPMSDlg::OnKillFocusDeptNo() 
{
...
void CReportEposPMSDlg::OnSelectDeptName() 
{
...
void CReportEposPMSDlg::OnButtonDisplaySingle() 
{
...
void CReportEposPMSDlg::OnButtonGraphSingle() 
{	
...
void CReportEposPMSDlg::OnButtonPrintMultiple() 
{
...
void CReportEposPMSDlg::OnButtonPrintQuick() 
{
...
void CReportEposPMSDlg::OnButtonPreset() 
{
...
void CReportEposPMSDlg::OnSelectPreset() 
{
