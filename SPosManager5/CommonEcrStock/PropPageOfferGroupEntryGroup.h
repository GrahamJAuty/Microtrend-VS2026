...
class CPropPageOfferGroupEntryGroup : public CSSPropertyPage
{
public:
	CPropPageOfferGroupEntryGroup();
	~CPropPageOfferGroupEntryGroup();

	//{{AFX_DATA(CPropPageOfferGroupEntryGroup)
...
public:
	//{{AFX_VIRTUAL(CPropPageOfferGroupEntryGroup)
	public:
...
protected:
	//{{AFX_MSG(CPropPageOfferGroupEntryGroup)
