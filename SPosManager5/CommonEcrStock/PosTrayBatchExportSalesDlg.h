...
class CPosTrayBatchExportSalesDlg : public CSSDialog
{
public:
	CPosTrayBatchExportSalesDlg( CPosTrayTask& BatchEmail, CWnd* pParent = NULL);
	~CPosTrayBatchExportSalesDlg();

	//{{AFX_DATA(CPosTrayBatchExportSalesDlg)
	enum { IDD = IDD_POSTRAY_BATCH_EXPORT_SALES };
	...
	CStatic m_staticMisc1;
	CSSComboBox	m_comboTaxField;
	...
	//{{AFX_VIRTUAL(CPosTrayBatchExportSalesDlg)
	protected:
...
protected:
	//{{AFX_MSG(CPosTrayBatchExportSalesDlg)
