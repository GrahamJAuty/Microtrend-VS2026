...
class CSingleListContentHelpersOPGroupInfo : public CSingleListContentHelpers
{
public:
	CSingleListContentHelpersOPGroupInfo( int nConLevel );
...
class CListDataOPGroupInfoDlg : public CListDataDlg
{
public:
	CListDataOPGroupInfoDlg( int nConLevel, int nEntityIdx, CWnd* pParent = NULL); 
	~CListDataOPGroupInfoDlg();
