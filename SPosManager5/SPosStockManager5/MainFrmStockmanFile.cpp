...
void CMainFrameStockman::OnFileCommsLogSystem() 
{
...
void CMainFrameStockman::OnFileCommsLogNetwork() 
{
...
void CMainFrameStockman::ShowNetworkCommsLog( int nNetworkIdx )
{
	CFilenameUpdater FnUp ( SysFiles::SchedLogPrm );
...
void CMainFrameStockman::OnFileEmailLog() 
{
...
void CMainFrameStockman::OnFilePosTrayLogAction() 
{
...
void CMainFrameStockman::OnFilePosTrayLogExport() 
{
...
void CMainFrameStockman::OnFileFNBLog() 
{
...
void CMainFrameStockman::OnFileS4LabourLog() 
{
...
void CMainFrameStockman::OnFileFTPLog() 
{
...
void CMainFrameStockman::OnFileBackup() 
{
...
void CMainFrameStockman::OnFileBackupLog() 
{
...
void CMainFrameStockman::OnFileBackupStatus()
{
...
void CMainFrameStockman::OnFileRestoreNormal()
{
...
void CMainFrameStockman::OnFileRestoreFolder()
{
...
void CMainFrameStockman::HandleFileRestore( bool bFolder ) 
{
...
int CMainFrameStockman::RestoreInternal( CString& strError, bool& bComplete, bool& bTerminatedLoyalty, CLockManagerInfo& infoLock, bool bRestoreToFolder )
{
	strError = "";
	bComplete = FALSE;
...
BOOL CMainFrameStockman::OnQueryEndSession() 
{
	...
	CString strMsg = "Stock Manager has detected a request to log off or shut down Windows.\n\n";
...
void CMainFrameStockman::OnEndSession(BOOL bEnding) 
{
	CMessageLoggerInfo info;
	info.m_nHideLevel = 2;
...
void CMainFrameStockman::OnAppExit() 
{
	OnClose();	
}
...
void CMainFrameStockman::OnImportSQL()
{
...
int CMainFrameStockman::ImportSQLInternal()
{
...
void CMainFrameStockman::OnClose() 
{
	...
	if ( DatabaseValidator.GetErrorFlag() == TRUE )
		Prompter.ContactDealer( "Stock Manager has detected an invalid database and needs to shut down.", TRUE );
	else
	{
...
long CMainFrameStockman::OnIDraughtExport( WPARAM wIndex, LPARAM lParam )
{
...
long CMainFrameStockman::OnSageExport( WPARAM wIndex, LPARAM lParam )
{
...
void CMainFrameStockman::OnFileSageLog() 
{
...
long CMainFrameStockman::OnIDraughtTransfer( WPARAM wIndex, LPARAM lParam )
{
...
void CMainFrameStockman::OnFileWriteLog() 
{
