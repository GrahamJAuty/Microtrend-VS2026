...
class CSingleListContentHelpersSalesHistoryStock : public CSingleListContentHelpers
{
public:
	CSingleListContentHelpersSalesHistoryStock();
...
class CListDataSalesHistoryStockDlg : public CListDataDlg
{
public:
	CListDataSalesHistoryStockDlg( int nInitialSel, CWnd* pParent = NULL); 
	~CListDataSalesHistoryStockDlg();
