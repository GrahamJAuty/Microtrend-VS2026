...
class CStockEditTransferRandomDlg : public CSSDialog
{
public:
	CStockEditTransferRandomDlg( CStockFilterArray* pStockFilterArray, CWnd* pParent = NULL);   

	//{{AFX_DATA(CStockEditTransferRandomDlg)
	enum { IDD = IDD_STOCK_EDIT_TRANSFER_RANDOM };
	...
	//{{AFX_VIRTUAL(CStockEditTransferRandomDlg)
	protected:
...
protected:
	//{{AFX_MSG(CStockEditTransferRandomDlg)
...
private:
	...
	CSSListCtrl m_listTransfer;
	CSubUnitEdit m_editStockSub;
	CStringArray m_TransferArray;
	CString m_strPluNo;
	int m_nEntryMode;
	int m_nStockIdx;
	int m_nDbNo;
