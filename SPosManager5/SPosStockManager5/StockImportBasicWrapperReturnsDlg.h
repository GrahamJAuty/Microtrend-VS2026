...
class CStockImportBasicWrapperReturnsDlg : public CStockImportBasicWrapperDlg
{
public:
	CStockImportBasicWrapperReturnsDlg ( int nSpIdx, int nSuppIdx, const char* szPath, const char* szReference1, const char* szReference2, CSuppRefFinder& SuppRefFinder, CStocktakeCSVRecord* pStocktake, CWnd* pParent );
