...
class CManualSalesEditPluDlg : public CSSDialog
{
public:
	CManualSalesEditPluDlg( int nSpIdx, const char* szSpOrLoc, CManualSalesEditPluDlg** pParentToThis, int nStkTakeNo, CWnd* pParent = NULL);   
	CManualSalesEditPluDlg( int nSpIdx, const char* szSpOrLoc, int nStkTakeNo, CWnd* pParent = NULL);   

	//{{AFX_DATA(CManualSalesEditPluDlg)
	enum { IDD = IDD_MANUAL_SALES_EDIT_PLU };
	...
	//{{AFX_VIRTUAL(CManualSalesEditPluDlg)
	protected:
...
protected:
	//{{AFX_MSG(CManualSalesEditPluDlg)
...
private:
	CManualSalesEditPluDlg** m_pParentToThis;
