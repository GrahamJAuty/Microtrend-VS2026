...
CGroupCSVArrayConsol::CGroupCSVArrayConsol() : CGroupCSVArrayBase()
{
}

/**********************************************************************/

int CGroupCSVArrayConsol::Open( const char* szFilename, int nMode )
{
	RemoveAt( 0, GetSize() );
...
void CGroupCSVArrayConsol::GetGroupInfo( int nIndex, CBaseGroupInfo& info )
{
	int nResult = 0;
...
bool CGroupCSVArrayConsol::GetListDataLine( int nIndex, CString& strLine )
{
	bool bResult = FALSE;
	m_strListDataLine = "";
...
void CGroupCSVArrayConsol::RememberSettings()
{
...
void CGroupCSVArrayConsol::RestoreSettings()
{
	RemoveAt( 0, GetSize() );
