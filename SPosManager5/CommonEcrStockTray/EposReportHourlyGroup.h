...
class CEposReportHourlyGroup : public CEposReportCoversTimedGroup
{
public:
	CEposReportHourlyGroup( CEposSelectArray& SelectArray, bool bDeptMode );
	CEposReportHourlyGroup( CEposSelectArray& SelectArray, const char* szCustomSettings, bool bDeptMode );
