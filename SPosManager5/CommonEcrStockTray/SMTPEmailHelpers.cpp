...
{
	CString strEmailFolder = "EmailSender";
...
void CSMTPEmailHelpers::CreatePendingEmail( const char* szAddress, const char* szSubject, const char* szFriendlyName, CReportFileDoc& ReportFileDoc, const char* szFilename )
{
	if ( m_strCurrentSession != "" )
	{
