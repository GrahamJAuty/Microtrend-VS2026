...
CEposReportPaymentReportGroup::CEposReportPaymentReportGroup(CEposSelectArray& SelectArray, const char* szCustomSettings) : CEposReportPaymentBase(SelectArray)
{
	m_nReportType = REPORT_TYPE_PAYMENT_GROUP_SUMMARY;
