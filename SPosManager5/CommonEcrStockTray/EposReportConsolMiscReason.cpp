...
CEposReportConsolMiscReason::CEposReportConsolMiscReason()
{
	Reset();
}
...
void CEposReportConsolMiscReason::Reset()
{
	m_bGrandTotal = FALSE;
...
void CEposReportConsolMiscReason::Add (CEposReportConsolMiscReason& source )
{
...
int CEposReportConsolMiscReason::Compare( CEposReportConsolMiscReason& source, int nHint )
{
...
bool CEposReportConsolMiscReason::CompareServer( CEposReportConsolMiscReason& source )
{
	if ( m_bGrandTotal != source.m_bGrandTotal )
		return FALSE;
