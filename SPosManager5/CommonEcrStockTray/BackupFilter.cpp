...
void CBackupFilter::AddStandardRules1()
{
	if ( FALSE == m_bGotStandardRules1 )
	{
		...
		//SERVER FILE
		Rule.m_strRuleString = "FILE3019.DAT";
		m_arrayRules.Add( Rule );

		//CUSTOMER FILE
		Rule.m_strRuleString = "FILE3034.DAT";
		m_arrayRules.Add( Rule );

		//CUSTOMER SYNC DATE
		Rule.m_strRuleString = "FILE3035.DAT";
		m_arrayRules.Add( Rule );

		//DEPOSIT NAMES
		Rule.m_strRuleString = "FILE3036.DAT";
		m_arrayRules.Add( Rule );

		//ONE OFF CUSTOMER NAMES
		Rule.m_strRuleString = "FILE3037.DAT";
		m_arrayRules.Add( Rule );

		//SUPPLIER
		Rule.m_strRuleString = "FILE2022.DAT";
		m_arrayRules.Add( Rule );

		//PMS
		Rule.m_strRuleString = "PMS";
		Rule.m_nRuleType = BACKUPFILTER_RULE_FOLDERCONTAINS;
		m_arrayRules.Add( Rule );
