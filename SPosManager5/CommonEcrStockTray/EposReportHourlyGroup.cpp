...
CEposReportHourlyGroup::CEposReportHourlyGroup( CEposSelectArray& SelectArray, bool bDeptMode ) : CEposReportCoversTimedGroup( SelectArray )
{
	Init( bDeptMode );
...
CEposReportHourlyGroup::CEposReportHourlyGroup( CEposSelectArray& SelectArray, const char* szCustomSettings, bool bDeptMode ) : CEposReportCoversTimedGroup( SelectArray )
{
	Init( bDeptMode );
...
void CEposReportHourlyGroup::Init( bool bDeptMode )
{
	...
	m_nReportType = m_bDeptMode ? REPORT_TYPE_HOURLY_DEPT : REPORT_TYPE_HOURLY_GROUP;
...
bool CEposReportHourlyGroup::GetDateOrTimeLabel( int nLocIdx, CString& strThisSaleDate, CString& strThisSaleTime, CString& strLabel )
{
	int nDayShift = 0;
	CString strTimeCode = "";
...
const char* CEposReportHourlyGroup::GetDateOrTimeReport( CString& strLabel )
{
