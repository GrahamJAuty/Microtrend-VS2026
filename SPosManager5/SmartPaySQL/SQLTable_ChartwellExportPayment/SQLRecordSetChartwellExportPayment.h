...
{
public:
	CSQLRecordSetMetadataChartwellExportPayment();
...
{
public:
	CSQLRecordSetChartwellExportPayment(CDatabase* pDatabase, RSParams_ChartwellExportPayment_NormalByTranDetail params);
