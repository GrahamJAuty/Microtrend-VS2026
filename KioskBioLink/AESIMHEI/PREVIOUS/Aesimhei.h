...
#define INTERFACE_VERSION   STRINGS_RETURNED
...
typedef struct
    ...
    long        PathSwitchLevel ;      /* Set by PC: PathCount level to switch coin to default path */
...
typedef struct
    ...
    long        InterfaceNumber ;        /* The bus / connection */
    long        UnitAddress ;            /* For addressable units */
    long        Value ;                  /* The value of the coins in this dispensor */
...
correspond to the quoted meanings.
****************************************************************/
long DLL OpenSpecificMHEVersion(char * SerialNumber, long InterfaceVersion) ;
...
****************************************************************/
void DLL IndicatorOn (long IndicatorNumber) ;
void DLL IndicatorOff(long IndicatorNumber) ;
...
long DLL SwitchCloses(long SwitchNumber) ;
...
****************************************************************/
long DLL CheckOperation(long Sequence, long Timeout) ;
...
typedef struct
    {
    long   EventCode ;         /* The code (as rturned by NextEvent */
...
long DLL NextEvent(EventDetailBlock* EventDetail) ;
...
****************************************************************/
void DLL ValueNeeded(long Amount) ;
...
****************************************************************/
long DLL EscrowThroughput (void) ;
...
****************************************************************/
long DLL BarcodeInEscrow (char BarcodeString[19]) ;
...
****************************************************************/
long DLL BarcodeStacked (char BarcodeString[19]) ;
...
longer returned.
****************************************************************/
long DLL BarcodePrintStatus (void) ;
...
****************************************************************/
long DLL ReadAcceptorDetails (long             Number,
...
****************************************************************/
void DLL WriteAcceptorDetails(long            Number,
                              AcceptorBlock*  Snapshot) ;
...
zero upwards.
****************************************************************/
long DLL ReadDispenserDetails(long             Number,
...
effect on the system.
****************************************************************/
void DLL WriteDispenserDetails(long              Number,
                               DispenserBlock*  Snapshot) ;
...
****************************************************************/
void DLL CounterIncrement(long CounterNo,
                          long Increment);
...
then call is silently ignored.
****************************************************************/
void DLL CounterCaption(long CounterNo,
                         char*    Caption);
...
****************************************************************/
long DLL CounterRead(long CounterNo);
...
****************************************************************/
__pchar DLL ReadCounterCaption(long CounterNo);
...
****************************************************************/
void DLL CounterDisplay (long DisplayCode) ;
...
None
****************************************************************/
void DLL E2PromReset(long LockE2Prom);
...
****************************************************************/
void DLL SetDeviceKey (long InterfaceNo,
                       long Address,
                       long Key);
...
****************************************************************/
void DLL WriteInterfaceBlock (long    Interface,
                              char*   Block,
                              long    Length) ;
...
****************************************************************/
long DLL ReadInterfaceBlock (long    Interface,
                             char*   Block,
                             long    Length) ;
...
****************************************************************/
long DLL RawPortResult(char Message[RAW_BLOCK_SIZE]) ;
...
****************************************************************/
long DLL FirmwareVersion (char* CompileDate,
                          char* CompileTime) ;
