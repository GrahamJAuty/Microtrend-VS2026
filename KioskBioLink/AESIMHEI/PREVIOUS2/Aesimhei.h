...
These constants are used when loading configuration records
...
****************************************************************/
PayStatuses DLL LastPayStatus(void) ;
...
****************************************************************/
BOOLEAN DLL ReadAcceptorDetails (long             Number,
...
zero upwards.
****************************************************************/
BOOLEAN DLL ReadDispenserDetails(long             Number,
...
None
****************************************************************/
MeterStatuses DLL MeterStatus ( void );
...
****************************************************************/
InterfaceStatus DLL ReadInterfaceBlock (long    Interface,
                                        char*   Block,
                                        long    Length) ;
...
InterfaceStatus DLL RawPortResult(char Message[RAW_BLOCK_SIZE]) ;
