...
CExternalParamsArray::CExternalParamsArray()
{
	...
	m_nParamIdxAddress1 = AddParam("ADDRESS1");
	m_nParamIdxAddress2 = AddParam("ADDRESS2");
	m_nParamIdxAddress3 = AddParam("ADDRESS3");
	m_nParamIdxAddress4 = AddParam("ADDRESS4");
	m_nParamIdxAddress5 = AddParam("ADDRESS5");
	m_nParamIdxPhone1 = AddParam("PHONE1");
	m_nParamIdxPhone2 = AddParam("PHONE2");
...
int CExternalParamsArray::Init(CString strCommand)
{
	...
	case EXTCOMMAND_CREATEUSER:
		...
		m_arrayParamsWanted.Add(m_nParamIdxAddress1);
		m_arrayParamsWanted.Add(m_nParamIdxAddress2);
		m_arrayParamsWanted.Add(m_nParamIdxAddress3);
		m_arrayParamsWanted.Add(m_nParamIdxAddress4);
		m_arrayParamsWanted.Add(m_nParamIdxAddress5);
		m_arrayParamsWanted.Add(m_nParamIdxPhone1);
		m_arrayParamsWanted.Add(m_nParamIdxPhone2);
...
void CExternalParamsArray::GetParams(CStringArray& arrayLines, CExternalReplyArray& arrayError)
{
	...
	while ( nLinePos < arrayLines.GetSize() )
	{
		...
		else
		{
			...
			else if (nParamPos == m_nParamIdxAddress1)
			{
				m_strAddress1 = strLine;
			}
			else if (nParamPos == m_nParamIdxAddress2)
			{
				m_strAddress2 = strLine;
			}
			else if (nParamPos == m_nParamIdxAddress3)
			{
				m_strAddress3 = strLine;
			}
			else if (nParamPos == m_nParamIdxAddress4)
			{
				m_strAddress4 = strLine;
			}
			else if (nParamPos == m_nParamIdxAddress5)
			{
				m_strAddress5 = strLine;
			}
			else if (nParamPos == m_nParamIdxPhone1)
			{
				m_strPhone1 = strLine;
			}
			else if (nParamPos == m_nParamIdxPhone2)
			{
				m_strPhone2 = strLine;
			}
