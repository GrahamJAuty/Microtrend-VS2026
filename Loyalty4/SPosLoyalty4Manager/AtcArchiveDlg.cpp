// AtcArchiveDlg.cpp : implementation file
//
...
CAtcArchiveDlg::CAtcArchiveDlg( const char* szFilename, const char* szTitle, CWnd* pParent/*=NULL*/)
	: CDialog(CAtcArchiveDlg::IDD, pParent)
...
BEGIN_MESSAGE_MAP(CAtcArchiveDlg, CDialog)
...
BOOL CAtcArchiveDlg::OnInitDialog()
{
...
void CAtcArchiveDlg::OnOK()
{
	if ( m_nDaysOut == 0 && m_nLinesOut == 0 )
		Prompter.Info( "No lines have been selected", m_strTitle );
	else
	{
		int nCurSel;
