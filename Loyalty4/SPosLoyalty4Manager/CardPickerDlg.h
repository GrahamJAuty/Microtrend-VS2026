...
class CCardPickerDlg : public CSSDialog
{
public:
...
private:
	void FillList();
	void AddLineToList(CSQLRowAccountList& RowAccount, int nIndex);
	bool CanAddLineToList(CSQLRowAccountList& RowAccount);
