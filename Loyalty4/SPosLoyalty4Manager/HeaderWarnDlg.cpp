...
CHeaderWarnDlg::CHeaderWarnDlg( CWnd* pParent) : CSSDialog(CHeaderWarnDlg::IDD, pParent)
{
	m_strTitle = "";
	m_strInfo1Text = "";
	m_strInfo2Text = "";
...
BEGIN_MESSAGE_MAP(CHeaderWarnDlg, CSSDialog)
	ON_BN_CLICKED(IDC_BUTTON_VIEW,OnButtonView)
END_MESSAGE_MAP()

//$$******************************************************************

BOOL CHeaderWarnDlg::OnInitDialog()
{
