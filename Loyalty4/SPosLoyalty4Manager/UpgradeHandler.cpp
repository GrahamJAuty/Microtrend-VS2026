...
CString CUpgradeHandler::GetSourceFolder()
{
	...
	//LOYALTY V3
	arraySources.Add("\\SPosEcrManager\\P45");
	arraySources.Add("\\SPosStockManager\\P45");
	arraySources.Add("\\SPosLoyalty3\\P45");
	//LOYALTY V2
	arraySources.Add("\\SPosEcrManager\\P41");
	arraySources.Add("\\SPosStockManager\\P41");
	arraySources.Add("\\EcrX500v3\\P41");
	arraySources.Add("\\StkX500v3\\P41");
	arraySources.Add("\\SPosLoyalty\\P41");
	arraySources.Add("\\LoyX500v2\\P41");
	//LOYALTY V1
	arraySources.Add("\\EcrX500v3\\P23");
	arraySources.Add("\\StkX500v3\\P23");
	arraySources.Add("\\LoyX500\\P23");
	arraySources.Add("\\EcrX500v2\\P23");
	arraySources.Add("\\StkX500v2\\P23");
	arraySources.Add("\\EcrX500\\P23");
	arraySources.Add("\\StkX500\\P23");
...
bool CUpgradeHandler::Upgrade()
{
	...
	if ( dlgUpgrade.DoModal() == IDOK )
	{
		...
		CServerPropertySheet dlg(Filenames.GetServerDataFilename(), m_pParent);
	...
	else
	{
		CString strMsg = "";
		strMsg += "Note:\n\n";
		strMsg += "The upgrade option will be available from the main menu until Loyalty Mananger\n";
