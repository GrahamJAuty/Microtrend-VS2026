...
CServiceLogonDlg::CServiceLogonDlg( CWnd* pParent )
	: CSSDialog(CServiceLogonDlg::IDD, pParent)
{
	m_strLastUsername = "";
...
{
	CDefEditDlg dlg( "Set Windows Password for Service", "", MAX_LENGTH_WINDOWS_PASSWORD, "Password", this );
	if ( dlg.DoModal() == IDOK )
	{
		if ( dlg.m_strName != "" )
		{
