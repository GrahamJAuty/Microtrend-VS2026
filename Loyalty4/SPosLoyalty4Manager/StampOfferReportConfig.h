...
class CStampOfferReportConfig
{
public:
	CStampOfferReportConfig(CString strLabel);
...
public:
	...
	bool GetShowEPOSRedeemFlag() { return m_bShowEPOSRedeem; }
	...
	int GetSingleOfferNo() { return m_nSingleOfferNo; }
...
public:
	...
	void SetShowEPOSRedeemFlag(bool b) { m_bShowEPOSRedeem = b; }
	...
	void SetSingleOfferNo(int n) { m_nSingleOfferNo = n; }
	void SetDbNo(int n);
