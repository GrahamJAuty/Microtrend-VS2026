...
CSystemPropertyPage7::CSystemPropertyPage7() : CSSPropertyPage(CSystemPropertyPage7::IDD)
{
	//{{AFX_DATA_INIT(CSystemPropertyPage7)
	//}}AFX_DATA_INIT
	m_nType = 0;
	m_nActiveTab = 0;
}
...
void CSystemPropertyPage7::DoDataExchange(CDataExchange* pDX)
{
	...
	//{{AFX_DATA_MAP(CSystemPropertyPage7)
...
BEGIN_MESSAGE_MAP(CSystemPropertyPage7, CPropertyPage)
	//{{AFX_MSG_MAP(CSystemPropertyPage7)
...
void CSystemPropertyPage7::OnTcnSelchangeTabs(NMHDR *pNMHDR, LRESULT *pResult)
{
	*pResult = 0;
...
void CSystemPropertyPage7::SetActiveTabControls()
{
	SetTabControls( TRUE );
};
...
void CSystemPropertyPage7::SetTabControls(bool bActiveTabOnly)
{
...
BOOL CSystemPropertyPage7::OnSetActive() 
{
	SetRecordControls();
...
void CSystemPropertyPage7::SetRecordControls()
{
...
void CSystemPropertyPage7::SaveRecord()
{
...
/**********************************************************************/
void CSystemPropertyPage7::OnRadioNone(){ SetType(0); }
void CSystemPropertyPage7::OnRadioHourly(){ SetType(1); }
void CSystemPropertyPage7::OnRadioDaily(){ SetType(2); }
void CSystemPropertyPage7::OnRadioWeekly(){ SetType(3); }
void CSystemPropertyPage7::OnRadioCustom(){ SetType(4); }
/**********************************************************************/

void CSystemPropertyPage7::SetType( int n )
{
	m_nType = n;
...
void CSystemPropertyPage7::OnTogglePrompt()
{
...
void CSystemPropertyPage7::OnButtonBrowse()
{
	CString strPathname = "";
...
void CSystemPropertyPage7::OnButtonEdit()
{
...
void CSystemPropertyPage7::OnButtonCheck()
{
...
void CSystemPropertyPage7::CheckBackupPath( bool bMessageIfOK )
{
...
bool CSystemPropertyPage7::ValidateFolderAccess(const char* szPath)
{
	bool bReply = FALSE;
...
void CSystemPropertyPage7::OnButtonSchedule()
{
...
void CSystemPropertyPage7::OnButtonInfo()
{
	SaveRecord();
