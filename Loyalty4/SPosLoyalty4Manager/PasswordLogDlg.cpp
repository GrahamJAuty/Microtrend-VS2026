//$$******************************************************************
#include "..\SPosLoyalty4Manager\RepmanHandler.h"
//$$******************************************************************
...
CPasswordLogDlg::CPasswordLogDlg(CWnd* pParent)
	: CSSDialog(CPasswordLogDlg::IDD, pParent)
{
}
...
BEGIN_MESSAGE_MAP(CPasswordLogDlg, CSSDialog)
	ON_CBN_SELCHANGE(IDC_COMBO_DATERANGE, OnSelectDateRange)
END_MESSAGE_MAP()

//$$******************************************************************

BOOL CPasswordLogDlg::OnInitDialog()
{
