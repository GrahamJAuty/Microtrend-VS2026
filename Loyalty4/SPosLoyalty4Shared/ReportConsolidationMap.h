...
public:
    ...
    explicit CReportConsolidationMap(Compare comp = Compare())
        : m_map(comp) {}

    void RemoveAll() { m_map.clear(); }
    void RemoveAt(const Key& key) { m_map.erase(key); }
...
public:
    ...
    explicit CReportUniqueMap(Compare comp = Compare())
        : m_map(comp) {
    }
...
public:
    ...
    explicit CReportMultiMap(Compare comp = Compare())
        : m_map(comp) {
    }
