...
void CSQLFieldValidatorPluInfo::SetDbNo(int n, int& nTarget)
{
	SetInt(n, nTarget, PluInfo::DbNo);
}
...
void CSQLFieldValidatorPluInfo::SetStampOfferID(int n, int& nTarget)
{
	SetInt(n, nTarget, PluInfo::StampOfferID);
}
