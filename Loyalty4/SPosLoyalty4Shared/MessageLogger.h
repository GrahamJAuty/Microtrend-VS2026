...
public:
	...
	void LogMemberMojoImportMessage(CString strMessage, bool bForce = FALSE);
	void LogThreadDiagnostic(int nType, int DbNo, int nFolderSet);
...
private:
	CString m_strLastMemberMojoMessage;
	COleDateTime m_lastMemberMojoTime;
};
