...
BEGIN_MESSAGE_MAP(CSPosLoyalty4ServerIconApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

//$$******************************************************************

CSPosLoyalty4ServerIconApp::CSPosLoyalty4ServerIconApp() : CWinApp( "Loyalty Server Icon" )
{
...
//$$******************************************************************
CSPosLoyalty4ServerIconApp theApp;
//$$******************************************************************
...
BOOL CSPosLoyalty4ServerIconApp::InitInstance()
{
	...
	if ( FALSE == bRegistered )
	{
		...
		strMess.Format("%s\n\n%s:\n\n ==> %s", (const char*)strError, (const char*)strText, (const char*)strField);
	...
	CSPosLoyalty4ServerIconDlg dlg;
	m_pMainWnd = &dlg;
